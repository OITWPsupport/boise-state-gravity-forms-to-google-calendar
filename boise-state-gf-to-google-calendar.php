...
function post_submission($entry, $form) {
	try {
		...
		*/ //'GravityFormtoGoogleCalendar-5c191c0932ae.json'
...
add_action('admin_menu', 'gc_admin_settings');

function gc_admin_settings() {
    $page_title = 'Gravity Forms to Google Calendar Settings';
    $menu_title = 'Gravity Forms to Google Calendar';
    $capability = 'edit_posts';
    $menu_slug = 'gf_to_gc_options';
    $function = 'gc_admin_settings_page_display';
    $icon_url = '';
    $position = 99;
...
function gc_display_theme_panel_fields() {
...
add_action("admin_init", "gc_display_theme_panel_fields");
